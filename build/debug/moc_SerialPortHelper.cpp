...
QT_MOC_LITERAL(1, 17, 14), // "receiveMessage"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 19) // "on_message_received"

    },
    "SerialPortHelper\0receiveMessage\0\0"
    "on_message_received"
};
...
void SerialPortHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_message_received(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (SerialPortHelper::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPortHelper::receiveMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialPortHelper::receiveMessage()
{
